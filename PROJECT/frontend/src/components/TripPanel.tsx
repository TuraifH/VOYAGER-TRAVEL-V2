...
export default function TripInput() {
  ...
  return (
    <div className="trip-panel">
      {journey.active ? (
        <button className="btn ghost full" onClick={endJourney}>
          <span className="material-symbols-outlined">stop</span> End journey
        </button>
      ) : (
        <button className="btn full" onClick={startJourney}>
